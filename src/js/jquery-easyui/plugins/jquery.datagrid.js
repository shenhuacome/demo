...
//_58.parent().addClass('out-scroll-grid').append("<div class='m-y-scroll'><div class='m-y-scroll-item'></div></div>")
...
$(".m-scroll-item").width($(".datagrid-view2 .datagrid-btable").outerWidth()-$(".datagrid-view2").outerWidth()+$(".datagrid-view").outerWidth());

$(".m-y-scroll-item").height($(".datagrid-view2 .datagrid-btable").outerHeight());

$(".m-scroll").on('scroll',function(){
	var _self=$(this);
	$(".datagrid-view2 .datagrid-body").scrollLeft(_self.scrollLeft());
})
