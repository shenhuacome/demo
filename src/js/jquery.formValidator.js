...
$.formValidator = 
{
	...
	setTipState : function(elem,showclass,showmsg)
	{
		...
		else
		{
			...
			else
			{
				...
				tip.show().removeClass("onError onFocus onShow onSuccess onCorrect").addClass( showclass ).html( showmsg );
				$(elem).removeClass("ui-onError ui-onFocus ui-Correct ui-onShow").addClass('ui-'+showclass);
	...
	setFailState : function(tipID,showmsg)
	{
	    ...
	    $(elem).removeClass("ui-onError ui-onFocus ui-onShow ui-Correct").addClass('ui-onError');
	},
